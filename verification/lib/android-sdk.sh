...
# Android SDK ロケーションの解決 (Android と KMP の消費者検証が共有する)。
#
# verification/android/ と verification/kmp/ は本体 (android/ / kmp/) と Sample に続く
...
#
# 未追跡ファイルを増やさないため verification/ 配下に local.properties は生成せず、
