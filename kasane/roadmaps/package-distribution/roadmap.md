...
| phase-6-maui-packaging | in-progress | change | [agenda](phases/phase-6-maui-packaging/agenda.md) | [add-maui-nuget-distribution](../../changes/add-maui-nuget-distribution/proposal.md) |
| phase-7-kmp-packaging | in-progress | change | [agenda](phases/phase-7-kmp-packaging/agenda.md) | [add-kmp-maven-distribution](../../changes/add-kmp-maven-distribution/proposal.md) |
