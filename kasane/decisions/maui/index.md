...
| [0004](0004-nuget-three-package-structure.md) | MAUI NuGet は facade + 輸送層 binding 2件の3パッケージ構成とし、SDK 標準の pack 経路で native 成果物を同梱する (2026-09-08 改訂: MAUI 本体の下限は workload 同梱版・最低 OS 版は buildTransitive ガード) | proposed | 2026-09-08 |
