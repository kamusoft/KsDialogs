...
- [release-workflow.md](architecture/release-workflow.md) — release workflow (4 形態の一斉公開): 6 段の構成、取り消せる順に並べた publish の順序、Maven Central の 2 枠 deployment と ID の引き継ぎ、印 (marker) による再実行の続行判定、Release ノートの組み立て、反映待ちの状態分類と smoke、待ちの時間予算
