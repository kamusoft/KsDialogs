...
internal class SampleTransitionPanelView(
    ...
    /** 選んだ演出の組。 */
    fun transition(): DialogTransition {
        val choice = SampleTransitionChoice.entries[presetChips.selectedIndex]
        return choice.transition(
            durationMilliseconds = durationMilliseconds(),
            easing = SampleEasingChoice.entries[easingChips.selectedIndex],
        )
    }
    ...
    /** スライダの位置から時間 (ミリ秒) を求める。 */
    private fun durationMilliseconds(): Int =
