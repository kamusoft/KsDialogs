...
/// <summary>Transition Dialog の中身。</summary>
public partial class TransitionDialogCardView : ContentView
{
    ...
    public TransitionDialogCardView(string message, Action onCancel, Action onComplete)
    {
        InitializeComponent();
        _onCancel = onCancel;
