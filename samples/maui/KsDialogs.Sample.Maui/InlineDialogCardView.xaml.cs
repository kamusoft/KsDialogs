...
/// <summary>Inline Dialog の中身。</summary>
public partial class InlineDialogCardView : ContentView
{
    ...
    public InlineDialogCardView(string message, Action onCancel, Action onComplete)
    {
        InitializeComponent();
        _onCancel = onCancel;
