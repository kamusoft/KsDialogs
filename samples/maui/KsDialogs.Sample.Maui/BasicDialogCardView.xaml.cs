...
/// <summary>Basic Dialog の中身。</summary>
public partial class BasicDialogCardView : ContentView
{
    ...
    public BasicDialogCardView(string message, Action onCancel, Action onComplete)
    {
        InitializeComponent();
        _onCancel = onCancel;
