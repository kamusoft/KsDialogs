...
/**
 * カスタム Loading の ViewModel 型と、中身の View / ViewModel の作り方の紐付け。
 *
 ...
 */
public interface LoadingViewRegistry {
    /**
     * ViewModel 型に対する ViewModel factory を登録する。
     *
     * 型を渡して表示する呼び出し ([KsLoading.show] / [KsLoading.start] のクラス参照を渡す形) は
     * この factory で ViewModel を作る。factory は表示のたびに呼ばれ、同じ型への再登録は後勝ちになる。
...
internal class SharedLoadingViewRegistry : LoadingViewRegistry {
